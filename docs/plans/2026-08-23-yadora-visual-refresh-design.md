# Yadora visual refresh

## Direction

Replace the synthetic dashboard, glow effects, pill badges, and repeated icon cards with a restrained editorial layout inspired by hospitality and architecture magazines. The supplied Yadora screenshot becomes the primary visual evidence of the product.
...
- Work index: replace the abstract dashboard mock with the supplied screenshot.
